...
interface AuthUris {
    ...
    val internalRedirectUri: String
    ...
    fun codeUri(clientId: String, additionalParams: String? = null): String {
        ...
        val authorizationUrl = buildString {
            ...
            append("scope=$scope&")
            append("redirect_uri=$localServiceUri/$internalRedirectUri")
...
data class SpotifyAuth(override val localServiceUri: String) : AuthUris {
    override val internalRedirectUri: String = "spotify_callback"
...
data class YouTubeAuth(override val localServiceUri: String) : AuthUris {
    override val internalRedirectUri: String = "youtube_callback"
